...
<div class="container">
    <div class="form-card">
<h2>Form Pengisian Kontrol Pasien</h2>
...
<input type="date" name="tanggal_kontrol">
</div>
</div>
...
<input type="number" name="kontrol_ke">
</div>

<div>
<label>Uang yang dikeluarkan</label>
<input type="number" name="uang_keluar">
</div>
</div>
...
<div>
<label>Sisa Uang Asuransi</label>
<input type="number" name="sisa_asuransi">
</div>
</div>

<div class="form-row full">
<label>Oleh Dokter</label>
