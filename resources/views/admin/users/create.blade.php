    ...
    <form action="{{ route('users.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <select id="usertype" name="usertype" required>
                ...
                <option value="rs" {{ old('usertype') == 'rs' ? 'selected' : '' }}>Rumah Sakit</option>
                <option value="puskes" {{ old('usertype') == 'puskes' ? 'selected' : '' }}>Puskesmas</option>
                <option value="jr" {{ old('usertype') == 'jr' ? 'selected' : '' }}>Jasa Raharja</option>
            </select>
        </div>
